  ...
  <div class="sidebar">
    ...
    <ul class="sidebar-list">
      <li class="sidebar-list-item">
        <a href="http://localhost/singup/project/home/aa.html">
    ...
    <div id="eventContainer" class="products-area-wrapper tableView">
     ...
     <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{--  <p class="card-text"><strong>Renter:</strong> {{ $booking->renter->name }}</p>  --}}
                            <p class="card-text"><strong>Total Price:</strong> {{ $booking->total_price }}</p>
                            <p class="card-text"><strong>Status:</strong> {{ $booking->status }}</p>
                            {{--  <p class="card-text"><strong>Status:</strong> {{ $booking->booking_id }}</p>  --}}
                            <!-- Add other property details as needed -->
                            <form action="{{ route('user.booking.delete', $booking->booking_id) }}" method="post">
                                @csrf
                                @method('DELETE')
            ...
            @endforeach
                    ...
                    <!-- Property Modal -->
                    <!-- Property Modal -->
<div class="modal fade" id="propertyModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="propertyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="propertyModalLabel">{{ $user->name }} Details</h5>
